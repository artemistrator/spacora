...
async function testCommentInsert() {
  ...
  try {
    ...
    console.log('Fetching a sample post...');
    ...
    // Get a sample space
    console.log('Fetching a sample space...');
    ...
    console.log('✅ Comment inserted successfully:', commentData[0]);
    ...
    console.log('\n🎉 All tests passed! The comments functionality should now work in the app.');
